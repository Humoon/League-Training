...
class TestActorCommunicator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._league_process = Process(target=lambda: LeagueMgr(
            port=11007, model_pool_addrs=["localhost:11001:11006"], mutable_hyperparam_type='MutableHyperparam').run())
    ...
    def test_request_learner_id(self):
        ...
        self.learner._model_pool_apis.push_model(None, self.learner_task.hyperparam, self.learner_task.model_key)
