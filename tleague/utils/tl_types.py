...
class ActorTask(object):
    ...
    def __str__(self):
        return str({'model_key1': self.model_key1, 'model_key2': self.model_key2, 'hyperparam': str(self.hyperparam)})
...
class MatchResult(object):
    ...
    def __str__(self):
        return str({'model_key1': self.model_key1, 'model_key2': self.model_key2, 'outcome': self.outcome, 'info': self.info})
