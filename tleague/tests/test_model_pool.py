...
class TestModelPoolClient(unittest.TestCase):
    ...
    def setUp(self):
        self._server_process1 = Process(target=lambda: ModelPool(ports="11001:11006").run())
        self._server_process2 = Process(target=lambda: ModelPool(ports="11002:11007").run())
    ...
    def test_push_model(self):
        client = ModelPoolAPIs(model_pool_addrs=["localhost:11001:11006", "localhost:11002:11007"])
        key1 = str(uuid.uuid1())
