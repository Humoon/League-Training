...
MutableHyperparamPartialPerturb_Config_SC2v1 = {
    ...
    'initial_sigma': 1 / 6.0,
    'initial_reward_weights': [[1] + [0] * 13 + [0, 0, 0], [1] + [0] * 13 + [0, 0.001, 0], [1] + [0] * 13 + [0, 0, 0.001]],
...
MutableHyperparamPreDefPartialPerturb_Config_SC2v1 = {
    ...
    'gamma':
        0.999,
    'reward_scale':
        0.05, # multiplied on the entry in perturb_ind
    'available_sigma': (
        1 / 0.6,
        1 / 6.0,
        1 / 60.0,
...
MutableHyperparamPreDefPartialPerturb_Config_SC2v2 = {
    ...
    'gamma':
        0.999,
    'reward_scale':
        0.01, # multiplied on the entry in perturb_ind
    'available_sigma': (
        1 / 0.6,
        1 / 6.0,
        1 / 60.0,
...
ConstantHyperparam_Config_SC2FullFormal_v10 = {
    ...
    'sigma':
        10.0,
    'reward_weights': [1.0] + [a * 0.01 for a in [0.0, 0.0, 1.0, 1.0, 0.2, 0.1, 0.5, 0.5, 2.0, 1.0, 2.0, 1.0, 0.5]] +
                      [0.0, 0.0, 0.005],
    'distill_model_key':
        'None:init_model'
}
