...
class HyperparamMgr(object):
    ...
    def __init__(self, model_pool_apis, mutable_hyperparam_type, hyperparam_config_name):
        self._model_pool_apis = model_pool_apis
        self._mutable_hyperparam_cls = getattr(hyperparam_types, mutable_hyperparam_type)
    ...
    def get_learner_hyperparam(self, learner_id, copy_from_model_key, is_mutate=True):
        if copy_from_model_key is None:
            ...
            hyperparam = self._model_pool_apis.pull_attr('hyperparam', copy_from_model_key)
