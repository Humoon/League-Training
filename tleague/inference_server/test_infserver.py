...
def main(_):
    ...
    replay_converter_type = getattr(importlib.import_module(converter_module), converter_name)
    ...
    hs_len = (
        policy_config['hs_len'] if ('hs_len' in policy_config) else 2 * policy_config['nlstm'] if
